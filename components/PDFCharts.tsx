...
export const PDFCharts: React.FC<PDFChartsProps> = ({ data }) => {
  if (data.length === 0) {
    return null;
  }
  ...
  return (
    <>
      ...
      <div style={{ marginTop: '30px', pageBreakInside: 'avoid' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '15px', color: '#374151' }}>
          Cash Value & Death Benefit Projection
        </h3>
      ...
      <div style={{ marginTop: '30px', pageBreakInside: 'avoid' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '15px', color: '#374151' }}>
          Out of Pocket & Cumulative Costs
        </h3>
        <div style={{ height: '300px', width: '100%' }}>
          <ResponsiveContainer width="100%" height={300}>
